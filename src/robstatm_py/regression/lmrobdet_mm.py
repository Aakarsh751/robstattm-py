...
from robstatm_py._converters import (
    extract_array,
    extract_bool,
    extract_float,
    extract_int,
)
from robstatm_py._errors import RobStatTMRError
from robstatm_py._r import r, r_pkg, rcall, rx2, rx2_opt
from robstatm_py.regression._formula import coef_names_for, df_with_r_names
...
from robstatm_py.regression.control import LmrobdetControl, _control_to_r
...
def lmrobdet_mm(
    ...
    *,
    ...
    True
    """
    from robstatm_py.regression._formula import resolve_formula_args
    ...
    # robstatm_py.datasets loaders), restore them so the user can write the
