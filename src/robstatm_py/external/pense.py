...
``pense`` (installed separately; see ``robstatm_py.check_setup()``).
...
from robstatm_py._converters import extract_array, validate_1d_numeric
...
def pense(
    ...
    *,
    ...
    Notes
    -----
    Stochastic (PY initial estimators). Call :func:`robstatm_py.set_seed`
...
def pense_cv(
    ...
    *,
    ...
    Notes
    -----
    Stochastic (CV folds + PY initials). Use :func:`robstatm_py.set_seed`
