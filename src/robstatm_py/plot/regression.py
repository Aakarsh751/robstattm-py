...
* ``backend="r"`` calls the Path-A helpers in :mod:`robstatm_py.plotting` and
...
from robstatm_py.plot._backends import (
    finish,
    finish_fig,
    get_ax,
    r_kwargs,
...
from robstatm_py.plot._data import (
    RegData,
    annotate_indices,
    flag_mask,
    regression_data,
...
def residuals(
    ...
    **kw,
    ...
    if be == "r":
        from robstatm_py import plotting
...
def diagnostics(
    ...
    **kw,
    ...
    from robstatm_py.plot._deps import require_pyplot
