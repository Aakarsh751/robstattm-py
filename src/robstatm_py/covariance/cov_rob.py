...
This is the same shape as :class:`robstatm_py.CovRobMMResult` and
:class:`robstatm_py.CovRobRockeResult`. We expose a separate
...
Use :func:`robstatm_py.set_seed` immediately before the call.
"""
...
from robstatm_py._converters import extract_array, extract_float
