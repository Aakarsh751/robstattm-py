...
from robstatm_py._r import r, r_pkg, rcall, rx2
from robstatm_py.regression._formula import (
    cleanup_r_var,
    coef_names_for,
    push_df_to_r,
)
...
from robstatm_py.regression.control_m import LmrobMControl, _control_m_to_r
...
def lmrob_m(
    ...
    *,
    ...
    control : LmrobMControl, optional
        Full tuning object (see :func:`robstatm_py.lmrobm_control`). When
