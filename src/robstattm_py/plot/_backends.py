...
from robstattm_py.plot._deps import (
    have_matplotlib,
    have_plotnine,
    require_matplotlib,
    require_plotnine,
...
from robstattm_py.plot._style import PlotStyle, apply_axes_style

_VALID = {"auto", "native", "matplotlib", "plotnine", "r"}

# kwargs understood by the Path-A (R) helpers in ``robstattm_py.plotting``.
