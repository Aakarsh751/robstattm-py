...
from robstattm_py.plot._style import (
    OKABE_ITO,
    PlotStyle,
    get_theme,
    set_theme,
...
from robstattm_py.plot.multivariate import (
    biplot,
    cov_heatmap,
    distance_distance,
    loadings,
...
from robstattm_py.plot.regression import (
    compare_fits,
    diagnostics,
    qq,
    resid_vs_leverage,
...
from robstattm_py.plot.univariate import location_scale
