...
class PrcompRobResult:
    ...
    def summary(self):
        ...
        Returns
        -------
        :class:`robstattm_py.pca._summary.PrcompRobSummary`
            Includes the 3×p ``importance`` matrix (sdev / proportion /
            cumulative), rounded by R to 5 decimals.
        """
        from robstattm_py.pca._summary import summary_of_prcomp
...
def prcomp_rob(
    ...
    *,
    ...
    Wraps ``RobStatTM::prcompRob``. Use :func:`robstattm_py.set_seed` before
