...
[ ]  Wrapper implemented                            — src/robstatm_py/<module>/<file>.py
...
[ ]  Coverage gate                                  — pytest --cov=src/robstatm_py/<module> --cov-fail-under=90
...
- `pytest --cov=src/robstatm_py/univariate --cov-fail-under=90` green.
...
- `pytest --cov=src/robstatm_py/regression --cov-fail-under=90` green.
...
- `pytest --cov=src/robstatm_py/covariance --cov-fail-under=90` AND `pytest --cov=src/robstatm_py/pca --cov-fail-under=90` green.
...
- PyPI `0.1.0` released.
- Install guide live; `robstatm_py.check_setup()` returns clean on at least one machine per OS.
